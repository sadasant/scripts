	...
	for i := 0; i < 20; i++ {
		for j := 0; j < 20; j++ {
			...
			if grid[i][j+1] > 50 && grid[i][j+2] > 50 && grid[i][j+3] > 50 {
				...
				break
			} else if grid[i+1][j+1] > 50 && grid[i+2][j+2] > 50 && grid[i+3][j+3] > 50 {
				prod *= grid[i+1][j+1] * grid[i+2][j+2] * grid[i+3][j+3]
			} else if grid[i+1][j] > 50 && grid[i+2][j] > 50 && grid[i+3][j] > 50 {
				prod *= grid[i+1][j] * grid[i+2][j] * grid[i+3][j]
			} else if j > 3 && grid[i+1][j-1] > 50 && grid[i+2][j-2] > 50 && grid[i+3][j-3] > 50 {
				prod *= grid[i+1][j-1] * grid[i+2][j-2] * grid[i+3][j-3]
			}
			if prod > max {
				max = prod
