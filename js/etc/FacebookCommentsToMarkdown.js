...
Array.prototype.map.call(document.getElementsByClassName("UFICommentActorName"), function(e) {
    var date = e.parentNode.nextSibling.firstChild.firstChild.firstChild.innerHTML;
    var name = e.text;
